...
print(fig1,'-dpng','-r0','../../results/disparity-results-edge/sawtooth/im26_ws_11_mss_50_1.png');
fig2 = figure;
...
print(fig2,'-dpng','-r0','../../results/disparity-results-edge/sawtooth/im26_ws_11_mss_50_2.png')